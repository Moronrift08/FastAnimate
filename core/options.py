...
class Options:
    ...
    ### training
    # workspace
    workspace: str = 'workspace_smplonly'
    # resume
    resume: Optional[str] = '/hpc2hdd/home/jshu704/Animation/LBS_LGM/core/workspace_LBS/checkpoints/model_xhuman_satge1.safetensors' #

    resume_stage2: Optional[str] = '/hpc2hdd/home/jshu704/Animation/LBS_LGM_nanjie/workspace_ft_new/checkpoints/model_90.safetensors'#'/hpc2hdd/home/gzhang292/nanjie/project3/model_xhuman_satge1.safetensors'
    # batch size (per-GPU)
    batch_size: int = 4
