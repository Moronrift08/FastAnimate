...
def vertices2landmarks(
    ...
    #print( "lmk_vertices.shape: ",lmk_vertices.shape)
    #print("lmk_bary_coords.shape: ", lmk_bary_coords.shape)
...
def lbs(
    ...
    '''
    betas = betas.unsqueeze(0)    # 为xhumans改动
    ...
    #print("Pose shape before view:", pose.shape)   # 查看 `pose` 的形状
    if pose2rot:
